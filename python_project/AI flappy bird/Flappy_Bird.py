...
for i in range(1,4):
    bird = f"bird{i}.png"
    BIRD_IMGS.append(pygame.transform.scale2x(pygame.image.load(os.path.join("imgs", bird))))
...
def main(genomes,config):  # sourcery no-metrics skip: extract-duplicate-method
    global GEN
    GEN += 1
    birds = []
    nets = []
